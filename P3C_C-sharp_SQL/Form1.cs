...
namespace P3C_C_sharp_SQL
{
    public partial class Form1 : Form
    {
        ...
        public Usuario pUsuario = new Usuario();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                pRegistro_Usuarios = new Registro_Usuarios();
            }
            pRegistro_Usuarios.ShowDialog();
            pRegistro_Usuarios.Dispose();
        }
    }
}
